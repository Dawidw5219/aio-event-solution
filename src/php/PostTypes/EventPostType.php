...
class EventPostType
{
  ...
  {
    require_once AIO_EVENTS_PATH . 'php/MetaBoxes/EventDetailsMetaBox.php';
    require_once AIO_EVENTS_PATH . 'php/MetaBoxes/BrevoIntegrationMetaBox.php';
    require_once AIO_EVENTS_PATH . 'php/MetaBoxes/EventRegistrationsMetaBox.php';

    \AIOEvents\MetaBoxes\EventDetailsMetaBox::register();
    \AIOEvents\MetaBoxes\BrevoIntegrationMetaBox::register();
    \AIOEvents\MetaBoxes\EventRegistrationsMetaBox::register();
  }
