...
class BrevoIntegrationMetaBox
{
  ...
  public static function render($post)
  {
    ...
    if ($post->post_status === 'auto-draft') {
      ...
      if (!metadata_exists('post', $post->ID, '_aio_event_email_template_join_event') && !empty($global_template_join_event)) {
        update_post_meta($post->ID, '_aio_event_email_template_join_event', absint($global_template_join_event));
      }
    ...
    $available_variables = \AIOEvents\Email\VariablesHelper::get_available_variables();
